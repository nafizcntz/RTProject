...
public class RTProject implements Runnable {
    ...
    public static synchronized void invertfonk(BufferedImage img, int StartWidth, int StartHeight, int bolme) { 
    ...
    public static synchronized void sepiafonk(BufferedImage img, int StartWidth, int StartHeight, int bolme) {
      int w = img.getWidth()/bolme;
      int h = img.getHeight()/bolme;
    ...
    public static synchronized void blurfonk(BufferedImage img, int StartWidth, int StartHeight, int bolme){
        int width = img.getWidth()/bolme; 
        int height = img.getHeight()/bolme; 
